...
(pic)
-Additionally, we need to delete the "Maintenance" Departement because we won't want tickets to be assigned to this department when practicing troubleshooting ticket handling in the next lab. 
</p>
<br />
